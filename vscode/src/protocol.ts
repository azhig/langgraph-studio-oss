/**
 * Protocol between the webview and the VS Code extension host. A copy of this file lives
 * in `vscode/src/protocol.ts`: the packages are built independently, but the types must match.
 *
...
export type ToWebview =
  ...
  /** A base64 chunk of the response body: SSE is text, but the body can also be binary. */
