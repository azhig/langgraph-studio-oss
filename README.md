...
```bash
pip install https://github.com/azhig/langgraph-studio-oss/releases/latest/download/langgraph_studio_oss-0.1.8-py3-none-any.whl
```
...
```bash
npm install -g https://github.com/azhig/langgraph-studio-oss/releases/latest/download/langgraph-studio-oss-0.1.8.tgz
langgraph-studio-oss --target http://127.0.0.1:2024 --port 8100
# → http://127.0.0.1:8100/studio
```
